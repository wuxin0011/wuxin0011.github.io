...
与我[ 联系 ](https://github.com/wuxin0011/wuxin0011.github.io/issues)格式：(点击代码块右上角一键复制)


```yaml
- name: wuxin0011`blog # 昵称
  desc: 一日复一日，明日何其多。 # 介绍
  avatar: https://cdn.staticaly.com/gh/wuxin0011/blog-resource@main/picgo/zookeeper.png # 头像
  link: https://wuxin0011.github.io/blog/  # 链接
```
       ...
       // 挂载图片加载失败事件
        window.document.querySelectorAll('img').forEach((img)=>{
          img.addEventListener('error',(e)=>{
                e.target.src = 'https://cdn.staticaly.com/gh/wuxin0011/blog-resource@main/bem/default-avatar.png'
              })
          })
    }
  }
