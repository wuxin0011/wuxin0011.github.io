...
* [Java全栈社区](https://www.pdai.tech/)
* [Java面试指南](https://javaguide.cn/)
* [前端必读](https://blog.touchczy.top/#/)



## 智能代码提示插件
- [copilot](https://github.com/features/copilot) 这个不用说，就是收费，一般人可以去网上找找网点购买
- [kite](http://kite.mi.com/) 对 python 提示友好，其他一般般
- [tabnine](https://www.tabnine.com/) 目前免费，但是特别耗内存，不推荐。
- [codota](https://plugins.jetbrains.com/plugin/7638-codota-ai-autocomplete-for-java-and-javascript)  jetbrains 下的一个智能提示插件，对 Java 和 JavaScript 提示友好
- [codewhishper](https://aws.amazon.com/cn/codewhisperer/) 用着还行，有免费和不免费的
- [intellicode](https://visualstudio.microsoft.com/services/intellicode/) 微软旗下的一款代码提示插件
- [cosy](https://help.aliyun.com/document_detail/368369.html) 阿里的智能提示插件
- [AIXcoder](https://plugins.jetbrains.com/plugin/13574-aixcoder-code-completer) jetbrains 下的一个智能提示插件


## 主题
- [vscode-theme](https://vscodethemes.com/?page=1) 在线查看 vscode 主题
...
- [可视化1](https://algo.hufeifei.cn/)
- [可视化2](https://visualgo.net/zh)
- [oi-wiki](https://oi-wiki.org/)
- [hello-allo](https://www.hello-algo.com/)
- [https://cp-algorithms.com/](https://cp-algorithms.com/)
- [灵茶山艾府](https://github.com/EndlessCheng/codeforces-go?tab=readme-ov-file)
- [template](https://github.com/hh2048/XCPC)
- [查看代码运行流程 Java C++ python Js 等](https://pythontutor.com/)

- [Java算法算法第四版](https://algs4.cs.princeton.edu/10fundamentals/)
...
- [Linux Command](https://wangchujiang.com/linux-command/list.html)
...
- [carrot](https://github.com/xx025/carrot)  这儿为你准备了众多免费好用的ChatGPT镜像站点，当前100+站点
...
- [vuepress系列](https://vuepress.vuejs.org/zh/)
...
* [touchczy](https://blog.touchczy.top/#/HTML/DOCTYPE) 写的十分优秀！非常值得看！
...
* [python的最佳实践](https://github.com/vinta/awesome-python)
...
- [code](https://aijihuo.cn/jetbrains-activation-codes.html)
...
- [all to all](https://www.alltoall.net/) 图片转换pdf 等 工具
## Talk
...
## 数据库
- [mongodb](https://account.mongodb.com/) 注册账号后有一个免费的 500MB 多云函数
      ...
      cardData0: [
        {
          ...
          cardImgSrc:
            "https://cdn.jsdelivr.net/gh/Kele-Bingtang/static@master/img/tools/20220104224044.png",
          cardName: "百度",
          cardContent:
        ...
        },
        {
          ...
          cardImgSrc:
            "https://cdn.jsdelivr.net/gh/Kele-Bingtang/static@master/img/tools/20220104225539.png",
          cardName: "Google",
        ...
        },
        {
          ...
          cardImgSrc:
            "https://cdn.jsdelivr.net/gh/Kele-Bingtang/static@master/img/tools/20220104224430.png",
          cardName: "Bing",
      ...
      cardData1: [
        {
          ...
          cardImgSrc:
            "https://cdn.jsdelivr.net/gh/Kele-Bingtang/static@master/img/tools/20220105001047.png",
          cardName: "Vue",
        ...
        },
        {
          ...
          cardImgSrc:
            "https://cdn.jsdelivr.net/gh/Kele-Bingtang/static@master/img/tools/20220105001602.png",
          cardName: "Element-UI",
          cardContent:
        ...
        },
        {
          ...
          cardImgSrc:
            "https://cdn.jsdelivr.net/gh/Kele-Bingtang/static@master/img/tools/20220105223748.svg",
        ...
        },
        {
          ...
          cardImgSrc:
            "https://cdn.jsdelivr.net/gh/Kele-Bingtang/static@master/img/tools/20220105001656.png",
          cardName: "View UI",
