...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
    ...
    themeConfig: {
        ...
        logo: 'https://cdn.jsdelivr.net/gh/wuxin0011/blog-resource@main/picgo/icon.png', // 导航栏logo
    ...
    head: [
        ...
        ['link', {rel: 'icon', href: 'https://cdn.jsdelivr.net/gh/wuxin0011/blog-resource@main/icon/logo.ico'}], //favicons，资源放在public文件夹
