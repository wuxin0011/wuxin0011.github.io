...
# 示例2：搜索描述中包含"小程序"，并且fork大于100，并且最近更新时间在2021-11-15之后的，并且使用开发语言为vue的项目
in:description 小程序 fork:>100 pushed:>2021-11-15 language:vue
```
